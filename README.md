...
Соединение по полю sys.indexes.data_space_id	

это Идентификатор пространства данных этого индекса. Пространством данных может быть или файловая группа, или схема секционирования.

В результате секционированные таблицы (со схемой секционирования) исключаются из результата запроса.
